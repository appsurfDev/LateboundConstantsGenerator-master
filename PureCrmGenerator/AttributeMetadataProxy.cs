...
namespace Rappen.XTB.LCG
{
    public class AttributeMetadataProxy : MetadataProxy
    {
        ...
        [DisplayName("Name")]
        public string DisplayName => Metadata?.LogicalName;
        ...
        internal string AttributeProperties
        {
            get
            {
                var properties = new Dictionary<string, object>
                {
                    ...
                    {"DisplayName:enum", (Metadata as EnumAttributeMetadata)?.OptionSet?.DisplayName?.UserLocalizedLabel?.Label.Replace("{", "").Replace("}", "").Replace("$", "") },
