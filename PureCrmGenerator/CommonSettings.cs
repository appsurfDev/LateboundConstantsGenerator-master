...
namespace Rappen.XTB.LCG
{
    public class CommonSettings
    {
        ...
        public string OptionSetEnumSuffix { get; set; } = "_os";
...
// Created by: Pure Crm " + DateTime.Now.Year + @" 
// Author    : Ian Mok Business Analyst
// Source Org: {organization}";
        ...
        public string JSClass { get; set; } = "public static class {classname}\n{\n{entity}\n{attributes}\n{relationships}\n{optionsets}\n}";
        public string JSEntity { get; set; } = "public const string EntityName = '{logicalname}';";
        public string JSAttribute { get; set; } = "public const string {attribute} = '{logicalname}';";
        public string JSRelationship { get; set; } = "public const string {relationship} = '{schemaname}';";
        public string JSOptionSet { get; set; } = "public enum {name}\n{\n{values}\n}";
        public string JSOptionSetValue { get; set; } = "{name} = {value}";
        public string JSRegion { get; set; } = "#region {region}\n{content}\n#endregion {region}";
    }
}
